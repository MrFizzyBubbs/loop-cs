...
var crimboCarols = $effects(lib_templateObject || (lib_templateObject = lib_taggedTemplateLiteral(["Do You Crush What I Crush?, Holiday Yoked, Let It Snow/Boil/Stink/Frighten/Grease, All I Want For Crimbo Is Stuff, Crimbo Wrapping"])));
...
function byClass(thing) {
  ...
  var class_ = (0,external_kolmafia_namespaceObject.myClass)().toString();
  return "default" in thing ? (_thing$class_ = thing[class_]) !== null && _thing$class_ !== void 0 ? _thing$class_ : thing.default : thing[class_];
}
...
function burnLibrams() {
  while (canCastLibrams()) {
    if (!CommunityService.FamiliarWeight.isDone()) {
      ...
      if (have(template_string_$skill(lib_templateObject2 || (lib_templateObject2 = lib_taggedTemplateLiteral(["Summon Candy Heart"])))) && totalDuration(template_string_$item(lib_templateObject3 || (lib_templateObject3 = lib_taggedTemplateLiteral(["green candy heart"])))) <= 0) {
        var _libramPossibilities$, _libramPossibilities$2;

        var probability = (_libramPossibilities$ = (_libramPossibilities$2 = libramPossibilities.get(template_string_$skill(lib_templateObject4 || (lib_templateObject4 = lib_taggedTemplateLiteral(["Summon Candy Heart"]))))) === null || _libramPossibilities$2 === void 0 ? void 0 : _libramPossibilities$2.get(template_string_$item(lib_templateObject5 || (lib_templateObject5 = lib_taggedTemplateLiteral(["green candy heart"]))))) !== null && _libramPossibilities$ !== void 0 ? _libramPossibilities$ : 0;
        decisionMap.set(template_string_$skill(lib_templateObject6 || (lib_templateObject6 = lib_taggedTemplateLiteral(["Summon Candy Heart"]))), 3 * probability);
      }

      if (have(template_string_$skill(lib_templateObject7 || (lib_templateObject7 = lib_taggedTemplateLiteral(["Summon Taffy"])))) && totalDuration(template_string_$item(lib_templateObject8 || (lib_templateObject8 = lib_taggedTemplateLiteral(["pulled blue taffy"])))) < 50) {
        var _libramPossibilities$3, _libramPossibilities$4;

        var _probability = (_libramPossibilities$3 = (_libramPossibilities$4 = libramPossibilities.get(template_string_$skill(lib_templateObject9 || (lib_templateObject9 = lib_taggedTemplateLiteral(["Summon Taffy"]))))) === null || _libramPossibilities$4 === void 0 ? void 0 : _libramPossibilities$4.get(template_string_$item(lib_templateObject10 || (lib_templateObject10 = lib_taggedTemplateLiteral(["pulled blue taffy"]))))) !== null && _libramPossibilities$3 !== void 0 ? _libramPossibilities$3 : 0;

        decisionMap.set(template_string_$skill(lib_templateObject11 || (lib_templateObject11 = lib_taggedTemplateLiteral(["Summon Taffy"]))), 1 * _probability);
      }

      if (have(template_string_$skill(lib_templateObject12 || (lib_templateObject12 = lib_taggedTemplateLiteral(["Summon Love Song"])))) && totalDuration(template_string_$item(lib_templateObject13 || (lib_templateObject13 = lib_taggedTemplateLiteral(["love song of icy revenge"])))) < 20) {
        var _libramPossibilities$5, _libramPossibilities$6;

        var _probability2 = (_libramPossibilities$5 = (_libramPossibilities$6 = libramPossibilities.get(template_string_$skill(lib_templateObject14 || (lib_templateObject14 = lib_taggedTemplateLiteral(["Summon Love Song"]))))) === null || _libramPossibilities$6 === void 0 ? void 0 : _libramPossibilities$6.get(template_string_$item(lib_templateObject15 || (lib_templateObject15 = lib_taggedTemplateLiteral(["love song of icy revenge"]))))) !== null && _libramPossibilities$5 !== void 0 ? _libramPossibilities$5 : 0;

        var currentWeightValue = utils_clamp(Math.ceil(totalDuration(template_string_$item(lib_templateObject16 || (lib_templateObject16 = lib_taggedTemplateLiteral(["love song of icy revenge"])))) / 2), 0, 10);
        var newWeightValue = utils_clamp(Math.ceil((totalDuration(template_string_$item(lib_templateObject17 || (lib_templateObject17 = lib_taggedTemplateLiteral(["love song of icy revenge"])))) + 5) / 2), 0, 10);
        decisionMap.set(template_string_$skill(lib_templateObject18 || (lib_templateObject18 = lib_taggedTemplateLiteral(["Summon Love Song"]))), _probability2 * (newWeightValue - currentWeightValue));
      }
...
function equipDefaults(outfit) {
  ...
  outfit.equip(template_string_$item(engine_outfit_templateObject16 || (engine_outfit_templateObject16 = engine_outfit_taggedTemplateLiteral(["Powerful Glove"]))), $slot(engine_outfit_templateObject17 || (engine_outfit_templateObject17 = engine_outfit_taggedTemplateLiteral(["acc1"]))));
  ...
  outfit.equip(byStat({
    Muscle: template_string_$items(engine_outfit_templateObject20 || (engine_outfit_templateObject20 = engine_outfit_taggedTemplateLiteral(["Brutal brogues, Kremlin's Greatest Briefcase"]))),
    Mysticality: template_string_$items(engine_outfit_templateObject21 || (engine_outfit_templateObject21 = engine_outfit_taggedTemplateLiteral(["battle broom, Kremlin's Greatest Briefcase"]))),
    Moxie: template_string_$items(engine_outfit_templateObject22 || (engine_outfit_templateObject22 = engine_outfit_taggedTemplateLiteral(["LOV Earrings, Beach Comb"])))
  }), $slot(engine_outfit_templateObject23 || (engine_outfit_templateObject23 = engine_outfit_taggedTemplateLiteral(["acc3"]))));
...
var engine_Engine = /*#__PURE__*/function (_BaseEngine) {
  ...
  engine_engine_createClass(Engine, [{
    key: "execute",
    value: function execute(task) {
      if (args.confirm && !(0,external_kolmafia_namespaceObject.userConfirm)("Executing ".concat(task.name, ", continue?"))) {
...
;// CONCATENATED MODULE: ./src/macro.ts
var macro_templateObject, macro_templateObject2, macro_templateObject3, macro_templateObject4, macro_templateObject5, macro_templateObject6, macro_templateObject7, macro_templateObject8, macro_templateObject9, macro_templateObject10;

function macro_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }

function macro_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function macro_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function macro_createClass(Constructor, protoProps, staticProps) { if (protoProps) macro_defineProperties(Constructor.prototype, protoProps); if (staticProps) macro_defineProperties(Constructor, staticProps); return Constructor; }

function macro_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) macro_setPrototypeOf(subClass, superClass); }

function macro_setPrototypeOf(o, p) { macro_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return macro_setPrototypeOf(o, p); }

function macro_createSuper(Derived) { var hasNativeReflectConstruct = macro_isNativeReflectConstruct(); return function _createSuperInternal() { var Super = macro_getPrototypeOf(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = macro_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return macro_possibleConstructorReturn(this, result); }; }

function macro_possibleConstructorReturn(self, call) { if (call && (typeof call === "object" || typeof call === "function")) { return call; } else if (call !== void 0) { throw new TypeError("Derived constructors may only return object or undefined"); } return macro_assertThisInitialized(self); }

function macro_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function macro_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }

function macro_getPrototypeOf(o) { macro_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return macro_getPrototypeOf(o); }




var macro_Macro = /*#__PURE__*/function (_StrictMacro) {
  macro_inherits(Macro, _StrictMacro);

  var _super = macro_createSuper(Macro);

  function Macro() {
    macro_classCallCheck(this, Macro);

    return _super.apply(this, arguments);
  }

  macro_createClass(Macro, [{
    key: "delevel",
    value: function delevel() {
      return this.trySkill(template_string_$skill(macro_templateObject || (macro_templateObject = macro_taggedTemplateLiteral(["Curse of Weaksauce"])))).trySkill(template_string_$skill(macro_templateObject2 || (macro_templateObject2 = macro_taggedTemplateLiteral(["Micrometeorite"])))).tryItem(template_string_$item(macro_templateObject3 || (macro_templateObject3 = macro_taggedTemplateLiteral(["Time-Spinner"])))).trySkill(template_string_$skill(macro_templateObject4 || (macro_templateObject4 = macro_taggedTemplateLiteral(["Summon Love Gnats"]))));
    }
  }, {
    key: "sing",
    value: function sing() {
      return this.skill(template_string_$skill(macro_templateObject5 || (macro_templateObject5 = macro_taggedTemplateLiteral(["Sing Along"]))));
    }
  }, {
    key: "kill",
    value: function kill() {
      return this.externalIf((0,external_kolmafia_namespaceObject.myClass)().primestat === $stat(macro_templateObject6 || (macro_templateObject6 = macro_taggedTemplateLiteral(["Muscle"]))), Macro.while_("!mpbelow ".concat((0,external_kolmafia_namespaceObject.mpCost)(template_string_$skill(macro_templateObject7 || (macro_templateObject7 = macro_taggedTemplateLiteral(["Lunging Thrust-Smack"]))))), Macro.skill(template_string_$skill(macro_templateObject8 || (macro_templateObject8 = macro_taggedTemplateLiteral(["Lunging Thrust-Smack"]))))), Macro.while_("!mpbelow ".concat((0,external_kolmafia_namespaceObject.mpCost)(template_string_$skill(macro_templateObject9 || (macro_templateObject9 = macro_taggedTemplateLiteral(["Saucestorm"]))))), Macro.skill(template_string_$skill(macro_templateObject10 || (macro_templateObject10 = macro_taggedTemplateLiteral(["Saucestorm"])))))).attack().repeat();
    }
  }, {
    key: "default",
...
function innerElfTask() {
  return {
    ...
    combat: new CombatStrategy().macro(macro_Macro.trySkill(template_string_$skill(common_templateObject3 || (common_templateObject3 = common_taggedTemplateLiteral(["KGB tranquilizer dart"])))).skill(template_string_$skill(common_templateObject4 || (common_templateObject4 = common_taggedTemplateLiteral(["Snokebomb"]))))),
    choices: {
      326: 1
    },
...
function meteorShowerTask() {
  return {
    ...
    completed: () => have($effect(common_templateObject8 || (common_templateObject8 = common_taggedTemplateLiteral(["Meteor Showered"])))),
    ...
    combat: new CombatStrategy().macro(macro_Macro.skill(template_string_$skill(common_templateObject10 || (common_templateObject10 = common_taggedTemplateLiteral(["Meteor Shower"])))).skill(template_string_$skill(common_templateObject11 || (common_templateObject11 = common_taggedTemplateLiteral(["Use the Force"]))))),
    choices: {
      1387: 3
    },
    outfit: {
    ...
    return {
      ...
      prepare: () => {
        if ((0,external_kolmafia_namespaceObject.myMp)() < (0,external_kolmafia_namespaceObject.mpCost)(skill)) {
          if (!have(template_string_$item(common_templateObject14 || (common_templateObject14 = common_taggedTemplateLiteral(["magical sausage"])))) && have(template_string_$item(common_templateObject15 || (common_templateObject15 = common_taggedTemplateLiteral(["magical sausage casing"]))))) {
          ...
          if (have(template_string_$item(common_templateObject17 || (common_templateObject17 = common_taggedTemplateLiteral(["magical sausage"]))))) {
...
function deckTask(card) {
  return {
    ...
    ready: () => have(template_string_$item(common_templateObject24 || (common_templateObject24 = common_taggedTemplateLiteral(["Deck of Every Card"])))) && property_get("_deckCardsDrawn") <= 10,
...
var BoozeDropQuest = {
  ...
  tasks: [skillTask(template_string_$skill(boozedrop_templateObject || (boozedrop_templateObject = boozedrop_taggedTemplateLiteral(["The Spirit of Taking"])))), skillTask(template_string_$skill(boozedrop_templateObject2 || (boozedrop_templateObject2 = boozedrop_taggedTemplateLiteral(["Singer's Faithful Ocelot"])))), skillTask(template_string_$skill(boozedrop_templateObject3 || (boozedrop_templateObject3 = boozedrop_taggedTemplateLiteral(["Fat Leon's Phat Loot Lyric"])))), boozedrop_objectSpread(boozedrop_objectSpread({}, skillTask($effect(boozedrop_templateObject4 || (boozedrop_templateObject4 = boozedrop_taggedTemplateLiteral(["Spice Haze"]))))), {}, {
    class: $classes(boozedrop_templateObject5 || (boozedrop_templateObject5 = boozedrop_taggedTemplateLiteral(["Seal Clubber, Turtle Tamer, Sauceror, Disco Bandit, Accordion Thief"])))
  }), {
    name: "Anticheese",
  ...
  }, potionTask(template_string_$item(boozedrop_templateObject6 || (boozedrop_templateObject6 = boozedrop_taggedTemplateLiteral(["government"]))), true), potionTask(template_string_$item(boozedrop_templateObject7 || (boozedrop_templateObject7 = boozedrop_taggedTemplateLiteral(["autumn leaf"])))), {
    name: "Oversized Sparkler",
    completed: () => have(template_string_$item(boozedrop_templateObject8 || (boozedrop_templateObject8 = boozedrop_taggedTemplateLiteral(["oversized sparkler"])))),
    ...
    name: "Batform",
    completed: () => have($effect(boozedrop_templateObject9 || (boozedrop_templateObject9 = boozedrop_taggedTemplateLiteral(["Bat-Adjacent Form"])))),
    do: $location(boozedrop_templateObject10 || (boozedrop_templateObject10 = boozedrop_taggedTemplateLiteral(["The Dire Warren"]))),
    combat: new CombatStrategy().macro(Macro.skill(template_string_$skill(boozedrop_templateObject11 || (boozedrop_templateObject11 = boozedrop_taggedTemplateLiteral(["Become a Bat"])))).skill(template_string_$skill(boozedrop_templateObject12 || (boozedrop_templateObject12 = boozedrop_taggedTemplateLiteral(["Bowl Straight Up"])))).skill(template_string_$skill(boozedrop_templateObject13 || (boozedrop_templateObject13 = boozedrop_taggedTemplateLiteral(["Reflex Hammer"]))))),
    outfit: {
      ...
      acc1: template_string_$item(boozedrop_templateObject15 || (boozedrop_templateObject15 = boozedrop_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"]))),
      familiar: template_string_$familiar(boozedrop_templateObject16 || (boozedrop_templateObject16 = boozedrop_taggedTemplateLiteral(["none"])))
    },
    limit: {
      tries: 1
    }
    ...
    name: "Play Pool",
    completed: () => have($effect(boozedrop_templateObject17 || (boozedrop_templateObject17 = boozedrop_taggedTemplateLiteral(["Hustlin'"])))),
    ...
    class: $classes(boozedrop_templateObject18 || (boozedrop_templateObject18 = boozedrop_taggedTemplateLiteral(["Turtle Tamer"])))
  }), {
    name: "Pray",
    class: $classes(boozedrop_templateObject19 || (boozedrop_templateObject19 = boozedrop_taggedTemplateLiteral(["Pastamancer"]))),
    completed: () => property_get("_barrelPrayer"),
    do: () => (0,external_kolmafia_namespaceObject.cliExecute)("barrelprayer buff"),
    limit: {
      tries: 1
    }
  }, boozedrop_objectSpread(boozedrop_objectSpread({}, potionTask(template_string_$item(boozedrop_templateObject20 || (boozedrop_templateObject20 = boozedrop_taggedTemplateLiteral(["Salsa Caliente\u2122 candle"]))))), {}, {
    class: $classes(boozedrop_templateObject21 || (boozedrop_templateObject21 = boozedrop_taggedTemplateLiteral(["Sauceror"])))
  }), {
    name: "Items.enh",
    completed: () => have($effect(boozedrop_templateObject22 || (boozedrop_templateObject22 = boozedrop_taggedTemplateLiteral(["items.enh"])))),
    do: () => enhance($effect(boozedrop_templateObject23 || (boozedrop_templateObject23 = boozedrop_taggedTemplateLiteral(["items.enh"])))),
    limit: {
      tries: 1
    }
  }, asdonTask("Observantly"), potionTask(template_string_$item(boozedrop_templateObject24 || (boozedrop_templateObject24 = boozedrop_taggedTemplateLiteral(["bag of grain"])))), {
    name: "Steely-Eyed Squint",
    completed: () => have($effect(boozedrop_templateObject25 || (boozedrop_templateObject25 = boozedrop_taggedTemplateLiteral(["Steely-Eyed Squint"])))),
    do: () => (0,external_kolmafia_namespaceObject.useSkill)(template_string_$skill(boozedrop_templateObject26 || (boozedrop_templateObject26 = boozedrop_taggedTemplateLiteral(["Steely-Eyed Squint"])))),
    limit: {
      tries: 1
    }
  }, skillTask($effect(boozedrop_templateObject27 || (boozedrop_templateObject27 = boozedrop_taggedTemplateLiteral(["Feeling Lost"])))), {
    name: "Test",
    completed: () => CommunityService.BoozeDrop.isDone(),
    do: () => CommunityService.BoozeDrop.run(() => undefined, 1),
    outfit: {
      hat: template_string_$item(boozedrop_templateObject28 || (boozedrop_templateObject28 = boozedrop_taggedTemplateLiteral(["wad of used tape"]))),
      weapon: template_string_$item(boozedrop_templateObject29 || (boozedrop_templateObject29 = boozedrop_taggedTemplateLiteral(["oversized sparkler"]))),
      offhand: template_string_$item(boozedrop_templateObject30 || (boozedrop_templateObject30 = boozedrop_taggedTemplateLiteral(["unbreakable umbrella"]))),
      ...
      acc1: template_string_$item(boozedrop_templateObject32 || (boozedrop_templateObject32 = boozedrop_taggedTemplateLiteral(["Guzzlr tablet"]))),
      acc2: template_string_$item(boozedrop_templateObject33 || (boozedrop_templateObject33 = boozedrop_taggedTemplateLiteral(["gold detective badge"]))),
      acc3: template_string_$items(boozedrop_templateObject34 || (boozedrop_templateObject34 = boozedrop_taggedTemplateLiteral(["barrel hoop earring, your cowboy boots"]))),
      famequip: template_string_$item(boozedrop_templateObject35 || (boozedrop_templateObject35 = boozedrop_taggedTemplateLiteral(["li'l ninja costume"]))),
      familiar: template_string_$familiar(boozedrop_templateObject36 || (boozedrop_templateObject36 = boozedrop_taggedTemplateLiteral(["Trick-or-Treating Tot"]))),
      modes: {
        umbrella: "bucket style"
      }
    },
    acquire: [{
      item: template_string_$item(boozedrop_templateObject37 || (boozedrop_templateObject37 = boozedrop_taggedTemplateLiteral(["wad of used tape"])))
    }],
    limit: {
      tries: 1
    }
...
var CoilWireQuest = {
  ...
  tasks: [{
    ...
    combat: new CombatStrategy().macro(macro_Macro.runaway()),
    outfit: {
    ...
    name: "Shrub Meat",
    completed: () => have($effect(coilwire_templateObject3 || (coilwire_templateObject3 = coilwire_taggedTemplateLiteral(["Everything Looks Red"])))),
    ready: () => have(template_string_$item(coilwire_templateObject4 || (coilwire_templateObject4 = coilwire_taggedTemplateLiteral(["cosmic bowling ball"])))),
    prepare: () => {
    ...
    combat: new CombatStrategy().macro(macro_Macro.skill(template_string_$skill(coilwire_templateObject6 || (coilwire_templateObject6 = coilwire_taggedTemplateLiteral(["Open a Big Red Present"])))).skill(template_string_$skill(coilwire_templateObject7 || (coilwire_templateObject7 = coilwire_taggedTemplateLiteral(["Bowl a Curveball"]))))),
    outfit: {
    ...
    combat: new CombatStrategy().macro(macro_Macro.skill(template_string_$skill(coilwire_templateObject10 || (coilwire_templateObject10 = coilwire_taggedTemplateLiteral(["Micrometeorite"])))).attack().repeat()),
    outfit: {
    ...
    completed: () => have(template_string_$item(coilwire_templateObject23 || (coilwire_templateObject23 = coilwire_taggedTemplateLiteral(["cherry"])))),
    ready: () => !have($effect(coilwire_templateObject24 || (coilwire_templateObject24 = coilwire_taggedTemplateLiteral(["Everything Looks Yellow"])))),
    do: () => {
    ...
    combat: new CombatStrategy().macro(macro_Macro.skill(template_string_$skill(coilwire_templateObject28 || (coilwire_templateObject28 = coilwire_taggedTemplateLiteral(["Spit jurassic acid"]))))),
    limit: {
      tries: 1
    }
  }, {
    ...
    completed: () => have(template_string_$item(coilwire_templateObject30 || (coilwire_templateObject30 = coilwire_taggedTemplateLiteral(["jumbo olive"])))),
    ready: () => !have($effect(coilwire_templateObject31 || (coilwire_templateObject31 = coilwire_taggedTemplateLiteral(["Everything Looks Yellow"])))),
    ...
    combat: new CombatStrategy().macro(macro_Macro.skill(template_string_$skill(coilwire_templateObject34 || (coilwire_templateObject34 = coilwire_taggedTemplateLiteral(["Spit jurassic acid"]))))),
    limit: {
      tries: 1
    }
  }, {
...
var FamiliarWeightQuest = {
  ...
  tasks: [familiarweight_objectSpread(familiarweight_objectSpread({}, skillTask(template_string_$skill(familiarweight_templateObject || (familiarweight_templateObject = familiarweight_taggedTemplateLiteral(["Chorale of Companionship"]))))), {}, {
    class: $classes(familiarweight_templateObject2 || (familiarweight_templateObject2 = familiarweight_taggedTemplateLiteral(["Accordion Thief"])))
  }), potionTask(template_string_$item(familiarweight_templateObject3 || (familiarweight_templateObject3 = familiarweight_taggedTemplateLiteral(["green candy heart"])))), beachTask($effect(familiarweight_templateObject4 || (familiarweight_templateObject4 = familiarweight_taggedTemplateLiteral(["Do I Know You From Somewhere?"])))), {
    name: "Puzzle Champ",
    ...
    name: "Play Pool",
    completed: () => have($effect(familiarweight_templateObject5 || (familiarweight_templateObject5 = familiarweight_taggedTemplateLiteral(["Billiards Belligerence"])))),
    ...
    name: "Fireworks Hat",
    completed: () => have(template_string_$item(familiarweight_templateObject6 || (familiarweight_templateObject6 = familiarweight_taggedTemplateLiteral(["sombrero-mounted sparkler"])))),
    prepare: () => (0,external_kolmafia_namespaceObject.visitUrl)("clan_viplounge.php?action=fwshop&whichfloor=2", false),
    ...
    name: "Yule Battery",
    completed: () => have(template_string_$item(familiarweight_templateObject8 || (familiarweight_templateObject8 = familiarweight_taggedTemplateLiteral(["overloaded Yule battery"])))),
    do: () => (0,external_kolmafia_namespaceObject.use)(template_string_$item(familiarweight_templateObject9 || (familiarweight_templateObject9 = familiarweight_taggedTemplateLiteral(["box of Familiar Jacks"])))),
    outfit: {
      familiar: template_string_$familiar(familiarweight_templateObject10 || (familiarweight_templateObject10 = familiarweight_taggedTemplateLiteral(["Mini-Trainbot"])))
    },
    acquire: [{
      item: template_string_$item(familiarweight_templateObject11 || (familiarweight_templateObject11 = familiarweight_taggedTemplateLiteral(["box of Familiar Jacks"])))
    }],
    limit: {
      tries: 1
    }
    ...
    name: "Icy Revenge",
    completed: () => have($effect(familiarweight_templateObject12 || (familiarweight_templateObject12 = familiarweight_taggedTemplateLiteral(["Cold Hearted"]))), 20),
    ready: () => have(template_string_$item(familiarweight_templateObject13 || (familiarweight_templateObject13 = familiarweight_taggedTemplateLiteral(["love song of icy revenge"])))),
    do: () => (0,external_kolmafia_namespaceObject.use)(template_string_$item(familiarweight_templateObject14 || (familiarweight_templateObject14 = familiarweight_taggedTemplateLiteral(["love song of icy revenge"])))),
    limit: {
      tries: 4
    }
  }, {
    name: "Blue Taffy",
    completed: () => have($effect(familiarweight_templateObject15 || (familiarweight_templateObject15 = familiarweight_taggedTemplateLiteral(["Blue Swayed"]))), 50),
    ready: () => have(template_string_$item(familiarweight_templateObject16 || (familiarweight_templateObject16 = familiarweight_taggedTemplateLiteral(["pulled blue taffy"])))),
    do: () => (0,external_kolmafia_namespaceObject.use)(template_string_$item(familiarweight_templateObject17 || (familiarweight_templateObject17 = familiarweight_taggedTemplateLiteral(["pulled blue taffy"])))),
    limit: {
      tries: 5
    }
  }, {
    ...
    do: () => {
      var desertAccessItem = (0,external_kolmafia_namespaceObject.knollAvailable)() ? template_string_$item(familiarweight_templateObject18 || (familiarweight_templateObject18 = familiarweight_taggedTemplateLiteral(["bitchin' meatcar"]))) : template_string_$item(familiarweight_templateObject19 || (familiarweight_templateObject19 = familiarweight_taggedTemplateLiteral(["Desert Bus pass"])));
  ...
  }, meteorShowerTask(), potionTask(template_string_$item(familiarweight_templateObject20 || (familiarweight_templateObject20 = familiarweight_taggedTemplateLiteral(["silver face paint"])))), libramTask(), {
    name: "Test",
    completed: () => CommunityService.FamiliarWeight.isDone(),
    ...
    outfit: {
      ...
      acc2: template_string_$item(familiarweight_templateObject26 || (familiarweight_templateObject26 = familiarweight_taggedTemplateLiteral(["Beach Comb"]))),
      acc3: template_string_$item(familiarweight_templateObject27 || (familiarweight_templateObject27 = familiarweight_taggedTemplateLiteral(["hewn moon-rune spoon"]))),
...
var HotResQuest = {
  ...
  tasks: [].concat(hotres_toConsumableArray($effects(hotres_templateObject || (hotres_templateObject = hotres_taggedTemplateLiteral(["Empathy, Leash of Linguini, Blood Bond"]))).map(skillTask)), hotres_toConsumableArray($effects(hotres_templateObject2 || (hotres_templateObject2 = hotres_taggedTemplateLiteral(["Feeling Peaceful, Astral Shell, Ghostly Shell"]))).map(skillTask)), [beachTask($effect(hotres_templateObject3 || (hotres_templateObject3 = hotres_taggedTemplateLiteral(["Hot-Headed"])))), {
    name: "Foam Suit",
    completed: () => have($effect(hotres_templateObject4 || (hotres_templateObject4 = hotres_taggedTemplateLiteral(["Fireproof Foam Suit"])))),
    ...
    combat: new CombatStrategy().macro(macro_Macro.skill(template_string_$skill(hotres_templateObject6 || (hotres_templateObject6 = hotres_taggedTemplateLiteral(["Fire Extinguisher: Foam Yourself"])))).skill(template_string_$skill(hotres_templateObject7 || (hotres_templateObject7 = hotres_taggedTemplateLiteral(["Use the Force"]))))),
    choices: {
      1387: 3
    },
    outfit: {
      ...
      offhand: template_string_$item(hotres_templateObject9 || (hotres_templateObject9 = hotres_taggedTemplateLiteral(["industrial fire extinguisher"]))),
      familiar: template_string_$familiar(hotres_templateObject10 || (hotres_templateObject10 = hotres_taggedTemplateLiteral(["none"])))
    },
    limit: {
      tries: 1
    }
    ...
    outfit: {
      weapon: template_string_$item(hotres_templateObject11 || (hotres_templateObject11 = hotres_taggedTemplateLiteral(["Fourth of May Cosplay Saber"]))),
      offhand: template_string_$item(hotres_templateObject12 || (hotres_templateObject12 = hotres_taggedTemplateLiteral(["industrial fire extinguisher"]))),
      back: template_string_$item(hotres_templateObject13 || (hotres_templateObject13 = hotres_taggedTemplateLiteral(["unwrapped knock-off retro superhero cape"]))),
      shirt: template_string_$item(hotres_templateObject14 || (hotres_templateObject14 = hotres_taggedTemplateLiteral(["Jurassic Parka"]))),
      pants: template_string_$item(hotres_templateObject15 || (hotres_templateObject15 = hotres_taggedTemplateLiteral(["designer sweatpants"]))),
      acc1: template_string_$item(hotres_templateObject16 || (hotres_templateObject16 = hotres_taggedTemplateLiteral(["Brutal brogues"]))),
      acc2: template_string_$item(hotres_templateObject17 || (hotres_templateObject17 = hotres_taggedTemplateLiteral(["hewn moon-rune spoon"]))),
      acc3: template_string_$item(hotres_templateObject18 || (hotres_templateObject18 = hotres_taggedTemplateLiteral(["Beach Comb"]))),
      familiar: template_string_$familiar(hotres_templateObject19 || (hotres_templateObject19 = hotres_taggedTemplateLiteral(["Exotic Parrot"]))),
      famequip: template_string_$item(hotres_templateObject20 || (hotres_templateObject20 = hotres_taggedTemplateLiteral(["tiny stillsuit"]))),
      modes: {
...
var buffs = {
  ...
  damage: $effects(leveling_templateObject6 || (leveling_templateObject6 = leveling_taggedTemplateLiteral(["Carol of the Hells, Carol of the Bulls, Frenzied, Bloody"], ["Carol of the Hells, Carol of the Bulls, Frenzied\\, Bloody"]))),
  elementalDamage: $effects(leveling_templateObject7 || (leveling_templateObject7 = leveling_taggedTemplateLiteral(["Takin' It Greasy, Intimidating Mien, Rotten Memories, Pyromania, Frostbeard"]))),
  survivability: $effects(leveling_templateObject8 || (leveling_templateObject8 = leveling_taggedTemplateLiteral(["Blood Bubble, Ruthlessly Efficient, Feeling Peaceful, Astral Shell, Ghostly Shell, Elemental Saucesphere"]))),
  monsterLevel: $effects(leveling_templateObject9 || (leveling_templateObject9 = leveling_taggedTemplateLiteral(["Ur-Kel's Aria of Annoyance, Pride of the Puffin, Drescher's Annoying Noise"])))
};
...
var _byStat = byStat({
  Muscle: {
    ...
    sauceEffect: $effect(leveling_templateObject12 || (leveling_templateObject12 = leveling_taggedTemplateLiteral(["Phorcefullness"])))
  },
  Mysticality: {
    ...
    sauceEffect: $effect(leveling_templateObject15 || (leveling_templateObject15 = leveling_taggedTemplateLiteral(["Mystically Oiled"])))
  },
  Moxie: {
    ...
    sauceEffect: $effect(leveling_templateObject18 || (leveling_templateObject18 = leveling_taggedTemplateLiteral(["Superhuman Sarcasm"])))
  }
}),
...
var synthEffect = byStat({
  Mysticality: $effect(leveling_templateObject19 || (leveling_templateObject19 = leveling_taggedTemplateLiteral(["Synthesis: Learning"]))),
  Moxie: $effect(leveling_templateObject20 || (leveling_templateObject20 = leveling_taggedTemplateLiteral(["Synthesis: Style"]))),
  Muscle: $effect(leveling_templateObject21 || (leveling_templateObject21 = leveling_taggedTemplateLiteral(["Synthesis: Movement"])))
});
var synthPairs = byStat({
  Mysticality: [[template_string_$item(leveling_templateObject22 || (leveling_templateObject22 = leveling_taggedTemplateLiteral(["Crimbo fudge"]))), template_string_$item(leveling_templateObject23 || (leveling_templateObject23 = leveling_taggedTemplateLiteral(["Crimbo fudge"])))], [template_string_$item(leveling_templateObject24 || (leveling_templateObject24 = leveling_taggedTemplateLiteral(["Crimbo fudge"]))), template_string_$item(leveling_templateObject25 || (leveling_templateObject25 = leveling_taggedTemplateLiteral(["bag of many confections"])))], [template_string_$item(leveling_templateObject26 || (leveling_templateObject26 = leveling_taggedTemplateLiteral(["Crimbo peppermint bark"]))), template_string_$item(leveling_templateObject27 || (leveling_templateObject27 = leveling_taggedTemplateLiteral(["Crimbo candied pecan"])))], [template_string_$item(leveling_templateObject28 || (leveling_templateObject28 = leveling_taggedTemplateLiteral(["Crimbo peppermint bark"]))), template_string_$item(leveling_templateObject29 || (leveling_templateObject29 = leveling_taggedTemplateLiteral(["peppermint sprout"])))], [template_string_$item(leveling_templateObject30 || (leveling_templateObject30 = leveling_taggedTemplateLiteral(["Crimbo candied pecan"]))), template_string_$item(leveling_templateObject31 || (leveling_templateObject31 = leveling_taggedTemplateLiteral(["peppermint crook"])))]],
  Muscle: [[template_string_$item(leveling_templateObject32 || (leveling_templateObject32 = leveling_taggedTemplateLiteral(["Crimbo fudge"]))), template_string_$item(leveling_templateObject33 || (leveling_templateObject33 = leveling_taggedTemplateLiteral(["Crimbo peppermint bark"])))], [template_string_$item(leveling_templateObject34 || (leveling_templateObject34 = leveling_taggedTemplateLiteral(["bag of many confections"]))), template_string_$item(leveling_templateObject35 || (leveling_templateObject35 = leveling_taggedTemplateLiteral(["Crimbo peppermint bark"])))], [template_string_$item(leveling_templateObject36 || (leveling_templateObject36 = leveling_taggedTemplateLiteral(["Crimbo candied pecan"]))), template_string_$item(leveling_templateObject37 || (leveling_templateObject37 = leveling_taggedTemplateLiteral(["peppermint patty"])))], [template_string_$item(leveling_templateObject38 || (leveling_templateObject38 = leveling_taggedTemplateLiteral(["peppermint sprout"]))), template_string_$item(leveling_templateObject39 || (leveling_templateObject39 = leveling_taggedTemplateLiteral(["peppermint twist"])))]],
...
var LOVEquipment = byStat({
  ...
  Mysticality: template_string_$item(_templateObject51 || (_templateObject51 = leveling_taggedTemplateLiteral(["LOV Epaulettes"]))),
  Moxie: template_string_$item(_templateObject52 || (_templateObject52 = leveling_taggedTemplateLiteral(["LOV Earrings"])))
});
var LevelingQuest = {
  name: "Leveling",
  completed: () => property_get("csServicesPerformed").split(",").length > 1 || property_get("_neverendingPartyFreeTurns") >= 10 && have($effect(_templateObject53 || (_templateObject53 = leveling_taggedTemplateLiteral(["Spit Upon"])))),
  tasks: [innerElfTask(), potionTask(generalStoreItem, true), leveling_objectSpread(leveling_objectSpread({}, potionTask(template_string_$item(_templateObject54 || (_templateObject54 = leveling_taggedTemplateLiteral(["flask of baconstone juice"]))))), {}, {
    class: $classes(_templateObject55 || (_templateObject55 = leveling_taggedTemplateLiteral(["Pastamancer, Turtle Tamer"])))
  }), // From juice bar
  leveling_objectSpread(leveling_objectSpread({}, potionTask(template_string_$item(_templateObject56 || (_templateObject56 = leveling_taggedTemplateLiteral(["potion of temporary gr8ness"]))))), {}, {
    class: $classes(_templateObject57 || (_templateObject57 = leveling_taggedTemplateLiteral(["Disco Bandit"])))
  }), // From juice bar
  leveling_objectSpread(leveling_objectSpread({}, potionTask(template_string_$item(_templateObject58 || (_templateObject58 = leveling_taggedTemplateLiteral(["pressurized potion of proficiency"]))))), {}, {
    class: $classes(_templateObject59 || (_templateObject59 = leveling_taggedTemplateLiteral(["Accordion Thief"])))
  }), // From juice bar
  leveling_objectSpread(leveling_objectSpread({}, potionTask(template_string_$item(_templateObject60 || (_templateObject60 = leveling_taggedTemplateLiteral(["natural magick candle"]))))), {}, {
    class: $classes(_templateObject61 || (_templateObject61 = leveling_taggedTemplateLiteral(["Seal Clubber, Pastamancer, Sauceror, Disco Bandit"])))
  }), leveling_objectSpread(leveling_objectSpread({}, potionTask(template_string_$item(_templateObject62 || (_templateObject62 = leveling_taggedTemplateLiteral(["Napalm In The Morning\u2122 candle"]))))), {}, {
    class: $classes(_templateObject63 || (_templateObject63 = leveling_taggedTemplateLiteral(["Seal Clubber, Turtle Tamer"])))
  }), leveling_objectSpread(leveling_objectSpread({}, potionTask(template_string_$item(_templateObject64 || (_templateObject64 = leveling_taggedTemplateLiteral(["votive of confidence"]))))), {}, {
    class: $classes(_templateObject65 || (_templateObject65 = leveling_taggedTemplateLiteral(["Turtle Tamer, Pastamancer, Accordion Thief"])))
  }), potionTask(template_string_$item(_templateObject66 || (_templateObject66 = leveling_taggedTemplateLiteral(["MayDay\u2122 supply package"]))))].concat(leveling_toConsumableArray($effects(_templateObject67 || (_templateObject67 = leveling_taggedTemplateLiteral(["Lack of Body-Building, We're All Made of Starfish, Pomp & Circumsands, You Learned Something Maybe!"]))).map(beachTask)), [{
    name: "Vaccine",
    ...
    name: "Sewer Items",
    completed: () => template_string_$items(_templateObject68 || (_templateObject68 = leveling_taggedTemplateLiteral(["turtle totem, saucepan, stolen accordion"]))).every(item => have(item)),
  ...
  }], leveling_toConsumableArray(buffs.stats.map(skillTask)), leveling_toConsumableArray(buffs.familiarWeight.map(skillTask)), leveling_toConsumableArray(buffs.damage.map(skillTask)), leveling_toConsumableArray(buffs.elementalDamage.map(skillTask)), leveling_toConsumableArray(buffs.survivability.map(skillTask)), [leveling_objectSpread(leveling_objectSpread({}, skillTask(byStat({
    Muscle: $effect(_templateObject71 || (_templateObject71 = leveling_taggedTemplateLiteral(["Quiet Determination"]))),
    Mysticality: $effect(_templateObject72 || (_templateObject72 = leveling_taggedTemplateLiteral(["Inscrutable Gaze"]))),
    Moxie: $effect(_templateObject73 || (_templateObject73 = leveling_taggedTemplateLiteral(["Quiet Desperation"])))
  }))), {}, {
    ...
    name: "Cloud-Talk",
    completed: () => have($effect(_templateObject77 || (_templateObject77 = leveling_taggedTemplateLiteral(["That's Just Cloud-Talk, Man"])))),
    ...
    do: () => {
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          ...
          var enough = candy1 === candy2 ? have(candy1, 2) : have(candy1) && (0,external_kolmafia_namespaceObject.retrieveItem)(candy2);
    ...
    name: "Ninja Costume",
    completed: () => have(template_string_$item(_templateObject81 || (_templateObject81 = leveling_taggedTemplateLiteral(["li'l ninja costume"])))) && have($effect(_templateObject82 || (_templateObject82 = leveling_taggedTemplateLiteral(["Giant Growth"])))),
    ...
    combat: new CombatStrategy().macro(macro_Macro.skill(template_string_$skill(_templateObject85 || (_templateObject85 = leveling_taggedTemplateLiteral(["Giant Growth"])))).skill(template_string_$skill(_templateObject86 || (_templateObject86 = leveling_taggedTemplateLiteral(["Chest X-Ray"]))))),
    outfit: {
      ...
      acc1: template_string_$item(_templateObject89 || (_templateObject89 = leveling_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"])))
    },
    limit: {
      tries: 1
    }
    ...
    name: "Nanorhino Buff",
    completed: () => have(byStat({
      Muscle: $effect(_templateObject90 || (_templateObject90 = leveling_taggedTemplateLiteral(["Nanobrawny"]))),
      Mysticality: $effect(_templateObject91 || (_templateObject91 = leveling_taggedTemplateLiteral(["Nanobrainy"]))),
      Moxie: $effect(_templateObject92 || (_templateObject92 = leveling_taggedTemplateLiteral(["Nanoballsy"])))
    })),
    ...
    combat: new CombatStrategy().macro(macro_Macro.skill(byClass({
    ...
    combat: new CombatStrategy().macro(macro_Macro.if_($monster(_templateObject108 || (_templateObject108 = leveling_taggedTemplateLiteral(["LOV Enforcer"]))), macro_Macro.attack().repeat()).if_($monster(_templateObject109 || (_templateObject109 = leveling_taggedTemplateLiteral(["LOV Engineer"]))), macro_Macro.skill(template_string_$skill(_templateObject110 || (_templateObject110 = leveling_taggedTemplateLiteral(["Weapon of the Pastalord"])))).repeat()).if_($monster(_templateObject111 || (_templateObject111 = leveling_taggedTemplateLiteral(["LOV Equivocator"]))), macro_Macro["default"]())),
    outfit: {
      offhand: template_string_$item(_templateObject112 || (_templateObject112 = leveling_taggedTemplateLiteral(["June cleaver"]))),
      shirt: template_string_$item(_templateObject113 || (_templateObject113 = leveling_taggedTemplateLiteral(["makeshift garbage shirt"])))
    },
    acquire: [{
      item: template_string_$item(_templateObject114 || (_templateObject114 = leveling_taggedTemplateLiteral(["makeshift garbage shirt"])))
    }],
    limit: {
      tries: 1
    }
  }, potionTask(template_string_$item(_templateObject115 || (_templateObject115 = leveling_taggedTemplateLiteral(["LOV Elixir #3"])))), potionTask(template_string_$item(_templateObject116 || (_templateObject116 = leveling_taggedTemplateLiteral(["LOV Elixir #6"])))), {
    name: "Ten-Percent Bonus",
    completed: () => !have(template_string_$item(_templateObject117 || (_templateObject117 = leveling_taggedTemplateLiteral(["a ten-percent bonus"])))),
    do: () => (0,external_kolmafia_namespaceObject.use)(template_string_$item(_templateObject118 || (_templateObject118 = leveling_taggedTemplateLiteral(["a ten-percent bonus"])))),
    outfit: {
      offhand: template_string_$item(_templateObject119 || (_templateObject119 = leveling_taggedTemplateLiteral(["familiar scrapbook"]))),
      equip: [LOVEquipment]
    },
    limit: {
      tries: 1
    ...
    outfit: {
      offhand: template_string_$item(_templateObject120 || (_templateObject120 = leveling_taggedTemplateLiteral(["familiar scrapbook"]))),
      equip: [LOVEquipment]
    },
    limit: {
      tries: 40
    ...
    do: $location(_templateObject121 || (_templateObject121 = leveling_taggedTemplateLiteral(["The X-32-F Combat Training Snowman"]))),
    combat: new CombatStrategy().macro(macro_Macro.trySkill(template_string_$skill(_templateObject122 || (_templateObject122 = leveling_taggedTemplateLiteral(["Bowl Straight Up"])))).default()),
    limit: {
      tries: 10
    }
  }, {
    name: "Post-Snojo Hottub",
    completed: () => $effects(_templateObject123 || (_templateObject123 = leveling_taggedTemplateLiteral(["Snowballed, Half-Blooded, Half-Drained, Bruised, Relaxed Muscles, Hypnotized, Bad Haircut"]))).every(effect => !have(effect)),
    ...
    do: () => (0,external_kolmafia_namespaceObject.useSkill)(template_string_$skill(_templateObject124 || (_templateObject124 = leveling_taggedTemplateLiteral(["Evoke Eldritch Horror"])))),
    post: () => {
      if (have($effect(_templateObject125 || (_templateObject125 = leveling_taggedTemplateLiteral(["Beaten Up"]))))) (0,external_kolmafia_namespaceObject.cliExecute)("hottub");
    },
    combat: new CombatStrategy().macro(macro_Macro["default"]()),
    outfit: {
      shirt: template_string_$item(_templateObject126 || (_templateObject126 = leveling_taggedTemplateLiteral(["makeshift garbage shirt"])))
    },
    acquire: [{
    ...
    outfit: {
      shirt: template_string_$item(_templateObject128 || (_templateObject128 = leveling_taggedTemplateLiteral(["makeshift garbage shirt"]))),
      famequip: template_string_$items(_templateObject129 || (_templateObject129 = leveling_taggedTemplateLiteral(["God Lobster's Ring, God Lobster's Scepter, tiny stillsuit"]))),
      familiar: template_string_$familiar(_templateObject130 || (_templateObject130 = leveling_taggedTemplateLiteral(["God Lobster"])))
    },
    acquire: [{
    ...
    completed: () => have(template_string_$item(_templateObject132 || (_templateObject132 = leveling_taggedTemplateLiteral(["imported taffy"])))) || have($effect(_templateObject133 || (_templateObject133 = leveling_taggedTemplateLiteral(["Imported Strength"])))),
    ready: () => property_get("_speakeasyFreeFights") < 3,
    do: () => mapMonster($location(_templateObject134 || (_templateObject134 = leveling_taggedTemplateLiteral(["An Unusually Quiet Barroom Brawl"]))), $monster(_templateObject135 || (_templateObject135 = leveling_taggedTemplateLiteral(["goblin flapper"])))),
    combat: new CombatStrategy().macro(macro_Macro.skill(template_string_$skill(_templateObject136 || (_templateObject136 = leveling_taggedTemplateLiteral(["Feel Envy"])))).skill(template_string_$skill(_templateObject137 || (_templateObject137 = leveling_taggedTemplateLiteral(["Portscan"])))).sing().kill()),
    limit: {
      tries: 1
    }
  }, potionTask(template_string_$item(_templateObject138 || (_templateObject138 = leveling_taggedTemplateLiteral(["imported taffy"])))), {
    ...
    combat: new CombatStrategy().macro(() => macro_Macro.externalIf(!have(template_string_$item(_templateObject140 || (_templateObject140 = leveling_taggedTemplateLiteral(["government cheese"])))), macro_Macro.skill(template_string_$skill(_templateObject141 || (_templateObject141 = leveling_taggedTemplateLiteral(["Feel Envy"]))))).externalIf(property_get("_speakeasyFreeFights") < 2, macro_Macro.skill(template_string_$skill(_templateObject142 || (_templateObject142 = leveling_taggedTemplateLiteral(["Portscan"]))))).default()),
    outfit: {
      shirt: template_string_$item(_templateObject143 || (_templateObject143 = leveling_taggedTemplateLiteral(["makeshift garbage shirt"]))),
      acc1: template_string_$item(_templateObject144 || (_templateObject144 = leveling_taggedTemplateLiteral(["backup camera"]))),
      modes: {
        backupcamera: "ml"
      }
    },
    ...
    name: "Witchess Witch",
    completed: () => have(template_string_$item(_templateObject146 || (_templateObject146 = leveling_taggedTemplateLiteral(["battle broom"])))),
    ready: () => fightsDone() < 5,
    do: () => fightPiece($monster(_templateObject147 || (_templateObject147 = leveling_taggedTemplateLiteral(["Witchess Witch"])))),
    combat: new CombatStrategy().macro(macro_Macro.trySkill(template_string_$skill(_templateObject148 || (_templateObject148 = leveling_taggedTemplateLiteral(["Curse of Weaksauce"])))).trySkill(template_string_$skill(_templateObject149 || (_templateObject149 = leveling_taggedTemplateLiteral(["Micrometeorite"])))).trySkill(template_string_$skill(_templateObject150 || (_templateObject150 = leveling_taggedTemplateLiteral(["Summon Love Stinkbug"])))).step(byStat({
      Mysticality: macro_Macro.attack(),
      default: macro_Macro.skill(template_string_$skill(_templateObject151 || (_templateObject151 = leveling_taggedTemplateLiteral(["Lunging Thrust-Smack"]))))
    })).repeat()),
    outfit: {
      weapon: template_string_$item(_templateObject152 || (_templateObject152 = leveling_taggedTemplateLiteral(["Fourth of May Cosplay Saber"]))),
      offhand: template_string_$item(_templateObject153 || (_templateObject153 = leveling_taggedTemplateLiteral(["familiar scrapbook"]))),
      shirt: template_string_$item(_templateObject154 || (_templateObject154 = leveling_taggedTemplateLiteral(["makeshift garbage shirt"])))
    },
    acquire: [{
      item: template_string_$item(_templateObject155 || (_templateObject155 = leveling_taggedTemplateLiteral(["makeshift garbage shirt"])))
    }],
    limit: {
      tries: 1
    }
    ...
    name: "Witchess King",
    completed: () => have(template_string_$item(_templateObject156 || (_templateObject156 = leveling_taggedTemplateLiteral(["dented scepter"])))),
    ready: () => fightsDone() < 5,
    do: () => fightPiece($monster(_templateObject157 || (_templateObject157 = leveling_taggedTemplateLiteral(["Witchess King"])))),
    combat: new CombatStrategy().macro(macro_Macro.delevel().attack().repeat()),
    outfit: {
      weapon: template_string_$item(_templateObject158 || (_templateObject158 = leveling_taggedTemplateLiteral(["Fourth of May Cosplay Saber"]))),
      offhand: template_string_$item(_templateObject159 || (_templateObject159 = leveling_taggedTemplateLiteral(["familiar scrapbook"]))),
      shirt: template_string_$item(_templateObject160 || (_templateObject160 = leveling_taggedTemplateLiteral(["makeshift garbage shirt"])))
    },
    acquire: [{
      item: template_string_$item(_templateObject161 || (_templateObject161 = leveling_taggedTemplateLiteral(["makeshift garbage shirt"])))
    }],
    limit: {
      tries: 1
    }
    ...
    name: "Witchess Queen",
    completed: () => have(template_string_$item(_templateObject162 || (_templateObject162 = leveling_taggedTemplateLiteral(["very pointy crown"])))),
    ready: () => fightsDone() < 5,
    do: () => fightPiece($monster(_templateObject163 || (_templateObject163 = leveling_taggedTemplateLiteral(["Witchess Queen"])))),
    combat: new CombatStrategy().macro(macro_Macro.item(template_string_$item(_templateObject164 || (_templateObject164 = leveling_taggedTemplateLiteral(["Time-Spinner"])))).attack().repeat()),
    outfit: {
      weapon: template_string_$item(_templateObject165 || (_templateObject165 = leveling_taggedTemplateLiteral(["Fourth of May Cosplay Saber"]))),
      offhand: template_string_$item(_templateObject166 || (_templateObject166 = leveling_taggedTemplateLiteral(["familiar scrapbook"]))),
      shirt: template_string_$item(_templateObject167 || (_templateObject167 = leveling_taggedTemplateLiteral(["makeshift garbage shirt"]))),
      familiar: template_string_$familiar(_templateObject168 || (_templateObject168 = leveling_taggedTemplateLiteral(["Shorter-Order Cook"])))
    },
    acquire: [{
      item: template_string_$item(_templateObject169 || (_templateObject169 = leveling_taggedTemplateLiteral(["makeshift garbage shirt"])))
    }],
    limit: {
      tries: 1
    }
  }], leveling_toConsumableArray(buffs.monsterLevel.map(skillTask)), [{
    name: "Deep Machine Tunnels",
    completed: () => property_get("_machineTunnelsAdv") >= 5,
    do: $location(_templateObject170 || (_templateObject170 = leveling_taggedTemplateLiteral(["The Deep Machine Tunnels"]))),
    combat: new CombatStrategy().macro(() => macro_Macro.externalIf(property_get("_machineTunnelsAdv") === 4, macro_Macro.skill(template_string_$skill(_templateObject171 || (_templateObject171 = leveling_taggedTemplateLiteral(["Portscan"]))))).default()),
    outfit: {
      shirt: template_string_$item(_templateObject172 || (_templateObject172 = leveling_taggedTemplateLiteral(["makeshift garbage shirt"]))),
      acc1: template_string_$item(_templateObject173 || (_templateObject173 = leveling_taggedTemplateLiteral(["backup camera"]))),
      familiar: template_string_$familiar(_templateObject174 || (_templateObject174 = leveling_taggedTemplateLiteral(["Machine Elf"]))),
      modes: {
        backupcamera: "ml"
      }
    },
    ...
    do: () => {
      (0,external_kolmafia_namespaceObject.visitUrl)((0,external_kolmafia_namespaceObject.toUrl)($location(_templateObject176 || (_templateObject176 = leveling_taggedTemplateLiteral(["The Neverending Party"])))));
    ...
    ready: () => getKramcoWandererChance() >= 1 && have(template_string_$item(_templateObject177 || (_templateObject177 = leveling_taggedTemplateLiteral(["cosmic bowling ball"])))),
    do: $location(_templateObject178 || (_templateObject178 = leveling_taggedTemplateLiteral(["The Neverending Party"]))),
    choices: {
      1322: 1
    },
    combat: new CombatStrategy().macro(macro_Macro.if_($monster(_templateObject179 || (_templateObject179 = leveling_taggedTemplateLiteral(["sausage goblin"]))), macro_Macro.skill(template_string_$skill(_templateObject180 || (_templateObject180 = leveling_taggedTemplateLiteral(["Bowl Sideways"])))).default()).abort()),
    outfit: {
      offhand: template_string_$item(_templateObject181 || (_templateObject181 = leveling_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"]))),
      shirt: template_string_$item(_templateObject182 || (_templateObject182 = leveling_taggedTemplateLiteral(["makeshift garbage shirt"]))),
      acc1: template_string_$item(_templateObject183 || (_templateObject183 = leveling_taggedTemplateLiteral(["backup camera"]))),
      modes: {
        backupcamera: "ml"
      }
    },
    acquire: [{
      item: template_string_$item(_templateObject184 || (_templateObject184 = leveling_taggedTemplateLiteral(["makeshift garbage shirt"])))
    }],
    limit: {
      tries: 1
    }
    ...
    completed: () => property_get("_neverendingPartyFreeTurns") >= 10 && have($effect(_templateObject185 || (_templateObject185 = leveling_taggedTemplateLiteral(["Spit Upon"])))),
    do: $location(_templateObject186 || (_templateObject186 = leveling_taggedTemplateLiteral(["The Neverending Party"]))),
    choices: {
      1324: 5
    },
    combat: new CombatStrategy().macro(macro_Macro.trySkill(template_string_$skill(_templateObject187 || (_templateObject187 = leveling_taggedTemplateLiteral(["Feel Pride"])))).trySkill(template_string_$skill(_templateObject188 || (_templateObject188 = leveling_taggedTemplateLiteral(["%fn, spit on me!"])))).default()),
    outfit: {
      shirt: template_string_$item(_templateObject189 || (_templateObject189 = leveling_taggedTemplateLiteral(["makeshift garbage shirt"]))),
      acc1: template_string_$item(_templateObject190 || (_templateObject190 = leveling_taggedTemplateLiteral(["backup camera"]))),
      modes: {
        backupcamera: "ml"
      }
    },
...
var NoncombatQuest = {
  ...
  tasks: [].concat(noncombat_toConsumableArray($effects(noncombat_templateObject || (noncombat_templateObject = noncombat_taggedTemplateLiteral(["Feeling Lonely, Smooth Movements, The Sonata of Sneakiness, Invisible Avatar"]))).map(skillTask)), [{
    name: "Silent Running",
    completed: () => have($effect(noncombat_templateObject2 || (noncombat_templateObject2 = noncombat_taggedTemplateLiteral(["Silent Running"])))),
    ...
    outfit: {
      ...
      familiar: template_string_$familiar(noncombat_templateObject9 || (noncombat_templateObject9 = noncombat_taggedTemplateLiteral(["Disgeist"]))),
      famequip: template_string_$item(noncombat_templateObject10 || (noncombat_templateObject10 = noncombat_taggedTemplateLiteral(["tiny stillsuit"]))),
      modes: {
        umbrella: "cocoon",
        parka: "pterodactyl"
      }
...
var PULLS = [template_string_$item(prologue_templateObject || (prologue_templateObject = prologue_taggedTemplateLiteral(["Great Wolf's beastly trousers"]))), template_string_$item(prologue_templateObject2 || (prologue_templateObject2 = prologue_taggedTemplateLiteral(["Stick-Knife of Loathing"])))];
...
var PrologueQuest = {
  ...
  tasks: [{
    name: "Workshed",
    completed: () => (0,external_kolmafia_namespaceObject.getWorkshed)() === template_string_$item(prologue_templateObject3 || (prologue_templateObject3 = prologue_taggedTemplateLiteral(["Asdon Martin keyfob"]))),
    do: () => (0,external_kolmafia_namespaceObject.use)(template_string_$item(prologue_templateObject4 || (prologue_templateObject4 = prologue_taggedTemplateLiteral(["Asdon Martin keyfob"])))),
    limit: {
      tries: 1
    }
  }, {
    name: "Garden",
    completed: () => [0, undefined].includes((0,external_kolmafia_namespaceObject.getCampground)()[template_string_$item(prologue_templateObject5 || (prologue_templateObject5 = prologue_taggedTemplateLiteral(["peppermint sprout"]))).name]),
    ...
    do: () => PULLS.filter(item => !have(item)).forEach(item => (0,external_kolmafia_namespaceObject.takeStorage)(1, item)),
    limit: {
      tries: 1
    }
  }, {
    ...
    completed: () => property_get("questM05Toot") === "finished" && !have(template_string_$item(prologue_templateObject6 || (prologue_templateObject6 = prologue_taggedTemplateLiteral(["letter from King Ralph XI"])))),
    do: () => (0,external_kolmafia_namespaceObject.use)(template_string_$item(prologue_templateObject7 || (prologue_templateObject7 = prologue_taggedTemplateLiteral(["letter from King Ralph XI"])))),
    limit: {
      tries: 1
    }
  }, {
    ...
    ready: () => have(template_string_$skill(prologue_templateObject8 || (prologue_templateObject8 = prologue_taggedTemplateLiteral(["Summon Alice's Army Cards"])))),
    do: () => (0,external_kolmafia_namespaceObject.useSkill)(1, template_string_$skill(prologue_templateObject9 || (prologue_templateObject9 = prologue_taggedTemplateLiteral(["Summon Alice's Army Cards"])))),
    limit: {
      tries: 1
    }
  }, {
    ...
    name: "Cowboy Boots",
    completed: () => have(template_string_$item(prologue_templateObject11 || (prologue_templateObject11 = prologue_taggedTemplateLiteral(["your cowboy boots"])))),
    ...
    completed: () => have(template_string_$item(prologue_templateObject14 || (prologue_templateObject14 = prologue_taggedTemplateLiteral(["gold detective badge"])))),
    ...
    outfit: {
      familiar: template_string_$familiar(prologue_templateObject15 || (prologue_templateObject15 = prologue_taggedTemplateLiteral(["Melodramedary"])))
    },
    limit: {
      tries: 1
    }
    ...
    name: "Vote!",
    completed: () => have(template_string_$item(prologue_templateObject16 || (prologue_templateObject16 = prologue_taggedTemplateLiteral(["\"I Voted!\" sticker"])))),
    do: () => {
    ...
    name: "Unlock Bird",
    completed: () => have(template_string_$skill(prologue_templateObject17 || (prologue_templateObject17 = prologue_taggedTemplateLiteral(["Seek out a Bird"])))),
    do: () => (0,external_kolmafia_namespaceObject.use)(template_string_$item(prologue_templateObject18 || (prologue_templateObject18 = prologue_taggedTemplateLiteral(["Bird-a-Day calendar"])))),
    limit: {
      tries: 1
    }
  }, {
    ...
    completed: () => have(template_string_$item(prologue_templateObject19 || (prologue_templateObject19 = prologue_taggedTemplateLiteral(["weeping willow wand"])))),
    do: () => (0,external_kolmafia_namespaceObject.retrieveItem)(template_string_$item(prologue_templateObject20 || (prologue_templateObject20 = prologue_taggedTemplateLiteral(["weeping willow wand"])))),
    limit: {
      tries: 1
    }
  }, {
...
var chefstaff = byStat({
  Mysticality: template_string_$item(spelldamage_templateObject || (spelldamage_templateObject = spelldamage_taggedTemplateLiteral(["Staff of the Roaring Hearth"]))),
  default: template_string_$item(spelldamage_templateObject2 || (spelldamage_templateObject2 = spelldamage_taggedTemplateLiteral(["Staff of Simmering Hatred"])))
});
...
var SpellDamageQuest = {
  ...
  tasks: [].concat(spelldamage_toConsumableArray($effects(spelldamage_templateObject3 || (spelldamage_templateObject3 = spelldamage_taggedTemplateLiteral(["Arched Eyebrow of the Archmage, Carol of the Hells, Jackasses' Symphony of Destruction, Simmering, Song of Sauce, Spirit of Cayenne"]))).map(skillTask)), [spelldamage_objectSpread(spelldamage_objectSpread({}, skillTask(template_string_$skill(spelldamage_templateObject4 || (spelldamage_templateObject4 = spelldamage_taggedTemplateLiteral(["Elron's Explosive Etude"]))))), {}, {
    class: $classes(spelldamage_templateObject5 || (spelldamage_templateObject5 = spelldamage_taggedTemplateLiteral(["Accordion Thief"])))
  }), {
    name: "Play Pool",
    completed: () => have($effect(spelldamage_templateObject6 || (spelldamage_templateObject6 = spelldamage_taggedTemplateLiteral(["Mental A-cue-ity"])))),
    ...
    completed: () => have($effect(spelldamage_templateObject7 || (spelldamage_templateObject7 = spelldamage_taggedTemplateLiteral(["Visions of the Deep Dark Deeps"])))),
    do: () => {
    ...
    completed: () => have($effect(spelldamage_templateObject21 || (spelldamage_templateObject21 = spelldamage_taggedTemplateLiteral(["Saucefingers"])))),
    ...
    outfit: {
      acc1: template_string_$item(spelldamage_templateObject23 || (spelldamage_templateObject23 = spelldamage_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"]))),
    ...
    combat: new CombatStrategy().macro(macro_Macro.skill(template_string_$skill(spelldamage_templateObject25 || (spelldamage_templateObject25 = spelldamage_taggedTemplateLiteral(["Reflex Hammer"]))))),
    limit: {
      tries: 2
    }
...
var Muscle = {
  ...
  tasks: [].concat(stat_toConsumableArray(skillBuffTasks("MUSCLE")), [thrallTask($thrall(stat_templateObject10 || (stat_templateObject10 = stat_taggedTemplateLiteral(["Elbow Macaroni"])))), equalizeTask(), {
    name: "Test",
    completed: () => CommunityService.Muscle.isDone(),
...
var Moxie = {
  ...
  tasks: [].concat(stat_toConsumableArray(skillBuffTasks("MOXIE")), [thrallTask($thrall(stat_templateObject11 || (stat_templateObject11 = stat_taggedTemplateLiteral(["Penne Dreadful"])))), equalizeTask(), {
    name: "Test",
    completed: () => CommunityService.Moxie.isDone(),
...
var Hitpoints = {
  ...
  tasks: [].concat(stat_toConsumableArray(skillBuffTasks("HP")), [potionTask(template_string_$item(stat_templateObject12 || (stat_templateObject12 = stat_taggedTemplateLiteral(["LOV Elixir #3"])))), thrallTask($thrall(stat_templateObject13 || (stat_templateObject13 = stat_taggedTemplateLiteral(["Elbow Macaroni"])))), beachTask($effect(stat_templateObject14 || (stat_templateObject14 = stat_taggedTemplateLiteral(["Lack of Body-Building"])))), equalizeTask(), {
    name: "Test",
    completed: () => CommunityService.HP.isDone(),
...
var WeaponDamageQuest = {
  ...
  tasks: [].concat(weapondamage_toConsumableArray(weapondamage_buffs.map(skillTask)), [potionTask(template_string_$item(weapondamage_templateObject2 || (weapondamage_templateObject2 = weapondamage_taggedTemplateLiteral(["LOV Elixir #3"])))), potionTask(template_string_$item(weapondamage_templateObject3 || (weapondamage_templateObject3 = weapondamage_taggedTemplateLiteral(["vial of hamethyst juice"])))), beachTask($effect(weapondamage_templateObject4 || (weapondamage_templateObject4 = weapondamage_taggedTemplateLiteral(["Lack of Body-Building"])))), {
    name: "Do You Crush What I Crush?",
    completed: () => have($effect(weapondamage_templateObject5 || (weapondamage_templateObject5 = weapondamage_taggedTemplateLiteral(["Do You Crush What I Crush?"])))),
    ready: () => crimboCarols.every(ef => !have(ef)),
    do: $location(weapondamage_templateObject6 || (weapondamage_templateObject6 = weapondamage_taggedTemplateLiteral(["The Dire Warren"]))),
    combat: new CombatStrategy().macro(Macro.skill(template_string_$skill(weapondamage_templateObject7 || (weapondamage_templateObject7 = weapondamage_taggedTemplateLiteral(["Reflex Hammer"]))))),
    outfit: {
      acc1: template_string_$item(weapondamage_templateObject8 || (weapondamage_templateObject8 = weapondamage_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"]))),
      familiar: template_string_$familiar(weapondamage_templateObject9 || (weapondamage_templateObject9 = weapondamage_taggedTemplateLiteral(["Ghost of Crimbo Carols"]))),
      famequip: template_string_$item.none
    },
    limit: {
      tries: 1
    ...
    completed: () => monstersReminisced().includes($monster(weapondamage_templateObject10 || (weapondamage_templateObject10 = weapondamage_taggedTemplateLiteral(["ungulith"])))),
    ...
    combat: new CombatStrategy().macro(Macro.skill(template_string_$skill(weapondamage_templateObject12 || (weapondamage_templateObject12 = weapondamage_taggedTemplateLiteral(["Meteor Shower"])))).skill(template_string_$skill(weapondamage_templateObject13 || (weapondamage_templateObject13 = weapondamage_taggedTemplateLiteral(["Use the Force"]))))),
    choices: {
      1387: 3
    },
    outfit: {
  ...
  }, potionTask(template_string_$item(weapondamage_templateObject15 || (weapondamage_templateObject15 = weapondamage_taggedTemplateLiteral(["corrupted marrow"])))), {
    name: "Bow-Legged Swagger",
    completed: () => property_get("_bowleggedSwaggerUsed"),
    do: () => (0,external_kolmafia_namespaceObject.useSkill)(template_string_$skill(weapondamage_templateObject16 || (weapondamage_templateObject16 = weapondamage_taggedTemplateLiteral(["Bow-Legged Swagger"]))))
  }, {
    name: "Test",
    completed: () => CommunityService.WeaponDamage.isDone(),
    ...
    outfit: {
      ...
      pants: template_string_$item(weapondamage_templateObject19 || (weapondamage_templateObject19 = weapondamage_taggedTemplateLiteral(["Great Wolf's beastly trousers"]))),
      acc1: template_string_$item(weapondamage_templateObject20 || (weapondamage_templateObject20 = weapondamage_taggedTemplateLiteral(["Brutal brogues"]))),
      acc2: template_string_$item(weapondamage_templateObject21 || (weapondamage_templateObject21 = weapondamage_taggedTemplateLiteral(["Powerful Glove"]))),
      acc3: template_string_$item(weapondamage_templateObject22 || (weapondamage_templateObject22 = weapondamage_taggedTemplateLiteral(["Kremlin's Greatest Briefcase"]))),
      famequip: template_string_$item(weapondamage_templateObject23 || (weapondamage_templateObject23 = weapondamage_taggedTemplateLiteral(["Stick-Knife of Loathing"]))),
      familiar: template_string_$familiar(weapondamage_templateObject24 || (weapondamage_templateObject24 = weapondamage_taggedTemplateLiteral(["Disembodied Hand"])))
    },
    acquire: [{
      item: template_string_$item(weapondamage_templateObject25 || (weapondamage_templateObject25 = weapondamage_taggedTemplateLiteral(["broken champagne bottle"])))
    }],
    limit: {
      tries: 1
    }
...
var DietQuest = {
  ...
  tasks: [{
    ...
    name: "Open Six-Pack",
    completed: () => !have(template_string_$item(diet_templateObject3 || (diet_templateObject3 = diet_taggedTemplateLiteral(["astral six-pack"])))),
